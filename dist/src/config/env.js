...
exports.env = void 0;
exports.validatePhase4Env = validatePhase4Env;
...
function validatePhase4Env() {
    ...
    if (isNaN(exports.env.router.slippageTolerance) || exports.env.router.slippageTolerance <= 0 || exports.env.router.slippageTolerance >= 1) {
        throw new Error('ROUTER_SLIPPAGE_TOLERANCE must be a number between 0 and 1');
    }
    if (exports.env.router.deadlineMinutes <= 0) {
        throw new Error('ROUTER_DEADLINE_MINUTES must be positive');
    }
    if (exports.env.router.maxHops <= 0 || exports.env.router.maxHops > 3) {
        throw new Error('ROUTER_MAX_HOPS must be between 1 and 3');
    }
    if (exports.env.router.minProfitUsd < 0) {
